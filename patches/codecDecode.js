...
/* ---------------------------------- utils --------------------------------- */
function readAmrwbPadFadeSamples() {
...
function scheduleCodecDebugDump(name, work) {
    void work.catch((err) => log_1.log.warn({ err, event: 'stt_codec_debug_dump_failed', name }, 'stt codec debug dump failed'));
}
